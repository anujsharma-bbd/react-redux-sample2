...
render(){
        ...
        return (
            <div className="panel-heading-btn">
                   ...
                   <a href="javascript:void(0);" className="btn btn-xs btn-icon btn-circle btn-warning" onClick={()=> this.props.onCollapse() } title='Collapse / Expand'><i className={dataModel.panelCollapsed?"fa fa-plus":"fa fa-minus"}></i></a>
